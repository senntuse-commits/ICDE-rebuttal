...
with year_total as (
 ...
 where t_s_secyear.customer_id = t_s_firstyear.customer_id
         ...
         and t_s_firstyear.dyear = enc_int4_encrypt('2001')
         and t_s_secyear.dyear = enc_int4_encrypt('2001')+'1'
         and t_w_firstyear.dyear = enc_int4_encrypt('2001')
         and t_w_secyear.dyear = enc_int4_encrypt('2001')+'1'
